...
const ansiIndex: Record<Color, number> = {
...
export function getAnsiCode(color: Color): string {
  return `\x1b[38;5;${ansiIndex[color]}m`;
}

export function resetCode(): string {
  return "\x1b[0m";
}
...
export function setColor(
  ...
  stream.write(getAnsiCode(color));
}

export function resetColor(stream: NodeJS.WriteStream = process.stdout): void {
  stream.write(resetCode());
}
